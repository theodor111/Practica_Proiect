...
navigate('/');
  ...
  /* ─── Render ─────────────────────────────────────────────────────────────── */
  return (
  // În Register.jsx, la div-ul principal:
// În Register.jsx
<div style={{ 
  minHeight: "100vh", 
  width: "100%", // Forțează lățimea
  display: "flex", 
  justifyContent: "center", 
  alignItems: "center", 
  padding: "20px", 
  position: "relative",
  // Folosește gradientul de siguranță din Login pentru a forța randarea
  backgroundImage: 'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("/cont3.jpeg")', 
  backgroundSize: 'cover',
  backgroundPosition: 'center',
  backgroundRepeat: 'no-repeat',
  backgroundAttachment: 'fixed' // Această linie este crucială pentru Vite
}}>
      {/* ── BACK ── */}
...
<div style={{ marginBottom: '28px' }}>
  ...
  <p style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '0.78rem', color: '#666', marginTop: '8px' }}>
    {formData.rol === 'organizator'
      ? 'Vei putea adăuga și gestiona evenimente.'
      : 'Vei putea explora și filtra evenimente.'}
  </p>
</div>
          {/* SUBMIT */}
