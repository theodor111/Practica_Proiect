...
import { Link } from 'react-router-dom'; // 1. Am adăugat acest import vital
import './App.css'
const categoriiDate = [
        ...
        <div className="app-root">
            <header>
                <nav>
                    ...
                    <a href="#">NIGHTLIFE</a>
                    <a href="#">ART</a>
                    <Link to="/login" className="active">CONT</Link>
                </nav>
            </header>
            ...
            <footer>
                ...
                <div className="footer-section">
                    <Link to="/contact" className="ClasaActiva">CONTACT</Link>
